...
SECRET_KEY = 'django-insecure-xi+b5vx@konumzez)x$ditrq!*@fyyife6665+@o^xixock+8a'
...
CORS_ALLOW_ORIGIN = ['http://localhost:3000', 'http://192.168.165.145:3000']  # 허용할 origin을 설정합니다.
...
WSGI_APPLICATION = 'BorrowedSkrr.wsgi.application'
